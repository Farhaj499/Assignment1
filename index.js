...
inquirer.prompt({
    ...
    choices: ['Sum Numbers', 'Check Even or Odd', 'Calculate Area', 'String Reversal', 'Temperature Conversion', 'exit'],
...
function checkEvenOrOdd(a) {
    if (a % 2 == 0)
        console.log(chalk.blueBright("Number is even"));
    else
        console.log(chalk.blueBright("Number is odd"));
}
